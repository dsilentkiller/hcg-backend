    ...
    <script src="{{ url('frontend/js/morphext.min.js') }}"></script> <!-- Morphtext rotating text in the header -->
    <script src="{{ url('frontend/js/isotope.pkgd.min.js') }}"></script> <!-- Isotope for filter -->
