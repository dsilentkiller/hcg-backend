...
<head>
    ...
    <rel="stylesheet" link href="{{ url('frontend/css/fontawesome-all.css') }}" />
    <rel="stylesheet" link href="{{url('frontend/css/swiper.css')  }}" >
	<rel="stylesheet" link href="{{ url('frontend/css/magnific-popup.css') }}" />
	<rel="stylesheet" link href="{{ url('frontend/css/styles.css') }}" />
